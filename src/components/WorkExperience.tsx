    ...
    <PageTitle preTitle="My Work">
      <SentenceGroup className="inline-flex w-fit flex-wrap">
        <LetterGroup>
          ...
          <span className="group-hover/sentence:translate-y-[-20%] group-hover/sentence:rotate-[-5deg] transform">c</span>
          <span className="group-hover/sentence:translate-x-[50%] group-hover/sentence:translate-y-[-40%] group-hover/sentence:rotate-[10deg] transform">e</span>
        </LetterGroup>
      </SentenceGroup>
    </PageTitle>
    <Grid className="flex-1">
      <Grid.Row>
        <Grid.Item position="up">
          <TiltBox hoverGrow>
            <img className="aspect-video ring-2 dark:ring-white ring-black" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn.wallpapersafari.com%2F83%2F26%2FTVC4pE.jpeg&f=1&nofb=1&ipt=3e708cd41f0adcc5ffe106178b729da1f7618611c72196f3703626f9d48b4cb5&ipo=images" alt="Care" />
        ...
        <Grid.Item position="down">
          <TiltBox className="relative" hoverGrow>
            <img className="card aspect-video ring-2 dark:ring-white ring-black" src="https://scontent-cph2-1.xx.fbcdn.net/v/t1.6435-9/74354974_2596311353768219_1372751520092651520_n.jpg?stp=dst-jpg_s960x960&_nc_cat=106&ccb=1-7&_nc_sid=13d280&_nc_ohc=0sdsJ27JzEUQ7kNvgG_FeWN&_nc_ht=scontent-cph2-1.xx&oh=00_AYDoCfh-CnEoJj0B_jvcpx9_GaCUyc2c2G3j6IY1hI25HQ&oe=66EFB8DF" alt="Me and Leopold Wigbratt" />
