    ...
    <PageWrapper id="education" className="flex flex-col mt-[4vmin]">
      <TitleWrapper>
        <SentenceGroup className="inline-flex w-fit flex-wrap">
          <LetterGroup>
            <span className="group-hover/sentence:translate-x-[-80%] group-hover/sentence/sentence:translate-y-[60%] group-hover/sentence/sentence:rotate-[4deg]">
              M
            </span>
      ...
      <Grid className="flex-1 place-items-center">
        <div className="w-[90%] md:max-w-[max(80vmin,40rem)] reveal">
          <picture>
            <source
              width={640}
              height={230}
          ...
          >
            <p>
              My education has provided me with a solid computer science
              foundation, focusing on web programming. During my studies, I
              honed my skills in programming, developing, and deploying robust
              web applications with high code quality across various platforms.
            </p>
          </Experience>
        </div>
      </Grid>
